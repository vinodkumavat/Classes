...
//creating query
$query = 'SELECT * FROM faculty';          //from faculty database

//get result
$result = mysqli_query($conn, $query);

//fetch data
$faculty = mysqli_fetch_all($result, MYSQLI_ASSOC);            //MYSQLI_(type of array)    Associative array means ['indexName'=>'value']  eg. ['Name'=>'Vinod']
